...
_G.packer_plugins = {
  ...
  ["vim-go"] = {
    loaded = true,
    path = "/home/lexo/.local/share/nvim/site/pack/packer/start/vim-go"
  },
  ["vim-surround"] = {
    loaded = true,
...
try_loadstring("\27LJ\1\0029\0\0\2\0\2\0\0044\0\0\0%\1\1\0>\0\2\1G\0\1\0\30plugins.configs.nvim-tree\frequire\0", "config", "galaxyline.nvim")
